...
INSERT INTO `commentaires` VALUES (1,1,1,'wow',NULL),(2,1,3,'commentaire initial',NULL),(3,2,3,'Réponse au commentaire initial',2);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `réponse` AFTER INSERT ON `commentaires` FOR EACH ROW BEGIN

    IF NEW.réponsecid IS NOT NULL THEN

        INSERT INTO repondre (idcommentaireparent, idcommentairereponse)
        VALUES (NEW.réponsecid, NEW.cid);
    END IF;
END */;;
DELIMITER ;
